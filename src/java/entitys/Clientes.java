...
@NamedQueries({
    ...
    , @NamedQuery(name = "Clientes.findByCompras", query = "SELECT c FROM Clientes c WHERE c.compras = :compras")
...
public class Clientes implements Serializable {
    ...
    public Clientes(Integer id, String nombre, String direccion, String correo, String compras, int telefono, String fecha, int cantidad, int cedula) {
        this.id = id;
        this.nombre = nombre;
